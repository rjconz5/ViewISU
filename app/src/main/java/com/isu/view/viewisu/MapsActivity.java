...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, View.OnClickListener {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions().position(gilman).title("Gilman Hall").snippet("+5 Points"));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(gilman));
        LatLng agronomy = new LatLng(42.028242, -93.642507);
        mMap.addMarker(new MarkerOptions().position(agronomy).title("Agronomy Hall").snippet("+5 Points"));
        ...
        mMap.addMarker(new MarkerOptions().position(lakeLaverne).title("Lake Laverne").snippet("+5 Points"));
        ...
        mMap.addMarker(new MarkerOptions().position(stateGym).title("State Gym").snippet("+5 Points"));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(stateGym));
        LatLng liedRec = new LatLng(42.026350, -93.637990);
        mMap.addMarker(new MarkerOptions().position(liedRec).title("Lied Rec Center").snippet("+5 Points"));
        ...
        mMap.addMarker(new MarkerOptions().position(howe).title("Howe Hall").snippet("+5 Points"));
        ...
        mMap.addMarker(new MarkerOptions().position(seasons).title("Seasons Dining Hall").snippet("+5 Points"));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(seasons));
        LatLng udcc = new LatLng(42.025187, -93.651250);
        mMap.addMarker(new MarkerOptions().position(udcc).title("Union Drive Community Center").snippet("+5 Points"));
